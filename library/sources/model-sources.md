...
solution: the model analogue of `asset-sources.md` (which covers texture *generators*).
...
- **Pixel-art-*styled* 3D is rare.** Most free models are generic low-poly, not pixel-textured.
