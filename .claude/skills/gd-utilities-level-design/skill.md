...
The draw-level grid constrains the *input tool*, not the *build output*. Door, window, and item tiles are opportunities to break grid monotony with rotated props, angled meshes, or decorative geometry — the builder places whatever mesh godot-dev chooses at those cells.
