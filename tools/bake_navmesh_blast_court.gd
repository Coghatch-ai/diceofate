# tools/bake_navmesh_blast_court.gd — headless: bake NavFloor NavigationMesh for blast_court.
# Usage: $GODOT --headless --path . --script tools/bake_navmesh_blast_court.gd
extends SceneTree

const SCENE_PATH: String = "res://levels/blast_court.tscn"
const OUTPUT_PATH: String = "res://levels/blast_court_navmesh.tres"
